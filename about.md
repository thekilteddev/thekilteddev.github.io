...
<h1>The machine and the Scotsman</h1>
</div>
<section>

The Kilted Dev is one person's field notes from a Windows laptop running more concurrent AI coding projects than it comfortably should: a pension calculator, a model router, a knowledge wiki, trading tools, and the content pipeline that publishes this site.
