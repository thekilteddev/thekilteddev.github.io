...
kilted-dev is one person's field notes from a Windows laptop running eighteen concurrent AI coding projects: a pension calculator, a model router, a knowledge wiki, trading tools, and the content pipeline that publishes this site.
